...
export default function ExperienceHero() {
  return (
    <section className="relative w-full min-h-[65vh] flex flex-col justify-between overflow-hidden bg-luxury-black pt-32 pb-14 px-6 sm:px-12 lg:px-16 xl:px-20 select-none">
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=2560&q=85"
          alt="Slowhouse Amenities & Experiences"
      ...
      <div className="relative z-10 max-w-3xl space-y-4 pt-4">
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-black/60 border border-orange-500/40 backdrop-blur-xl text-xs uppercase tracking-luxury text-orange-400 shadow-[0_0_20px_rgba(255,107,0,0.2)]">
          ...
          <span>Curated Immersions & Signature Amenities</span>
        </div>
        ...
        <p className="text-base sm:text-xl text-white/80 font-light max-w-xl leading-relaxed">
          Open-sky thermal pools, sunset catamaran charters, private sommelier cellars, and alpine ridge excursions.
        </p>
      </div>
      ...
      <div className="relative z-10 flex items-center space-x-3 pt-6">
        <div className="px-4 py-2 bg-black/55 backdrop-blur-xl border border-orange-500/30 rounded-full text-xs font-medium text-white flex items-center space-x-2">
          ...
          <span>Private Concierge Access Included with Every Stay</span>
        </div>
      </div>
    </section>
  );
